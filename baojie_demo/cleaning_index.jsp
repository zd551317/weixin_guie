...
.option {
    ...
    color:#191919;
    background-image:url(<%=path %>/images/checkbox.png);
...
<!--header顶部标题-->
<div class="header">保洁
	<div class="header_left" onclick="window.history.go(-1)"><img src="<%=path %>images/return.png"></div>
    <div class="header_right" id="open_sta" onClick="statement()">免责声明</div>
</div>
<!--column服务地址-->
<div class="column_box" onclick="document.location='address.html';">
	<div class="border_top"></div>
	<div class="column_img"><img src="<%=path %>/images/adrress.png"></div>
    <p>请选择服务地址</p>
    <div class="next"><img src="<%=path %>/images/arrow.png"></div>
    <div class="border_bottom"></div>
</div>
<!--选取地址后的服务地址，先隐藏，选取地址后显示-->
<div class="address">
	<div class="border_top"></div>
    <img src="<%=path %>/images/adrress.png">
...
<div class="column_box" >
	<div class="border_top"></div>
	<div class="column_img"><img src="<%=path %>/images/area.fw.png"></div>
    <p>请选择房屋面积（㎡）</p>
    
</div>
<div style=" width:92%; border-top:1px #cccccc solid; margin:auto;"></div>	
    <div class="area current">1-100</div>  
    <div class="area">101-130</div>
    <div class="area">130-160</div>
    <div class="area">160-200</div>
    <div class="area">200-260</div>
    <div class="area">260-380</div>
    <div class="area">380-500</div>
    <div class="area">500-720</div>   
    <div class="border_bottom"></div>
...
<div class="column_box column_ron" style="margin-top:14px;">
	<div class="border_top"></div>
	<div class="column_img"><img src="<%=path %>/images/time.png"></div>
...
<div class="confirm_box">
	<div class="confirm" onclick="document.location='affirm_order.html';">提交订单</div>
</div>
<!--免责声明-->
...
<div class="statement" id="statement">
    ...
    <img class="close" onClick="close_sta()" src="<%=path %>/images/close.png">
